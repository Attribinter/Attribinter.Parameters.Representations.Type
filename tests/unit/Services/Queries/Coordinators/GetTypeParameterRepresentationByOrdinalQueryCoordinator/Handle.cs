...
public sealed class Handle
{
    ...
    private static Expression<Func<DCreateQueryThroughFactory<IGetTypeParameterRepresentationByOrdinalQueryFactory, IGetTypeParameterRepresentationByOrdinalQuery>, bool>> MatchQueryCreationDelegate(
        int ordinal)
    {
    ...
    private static bool VerifyQueryCreationDelegate(
        DCreateQueryThroughFactory<IGetTypeParameterRepresentationByOrdinalQueryFactory, IGetTypeParameterRepresentationByOrdinalQuery> queryCreationDelegate,
        int ordinal)
    {
