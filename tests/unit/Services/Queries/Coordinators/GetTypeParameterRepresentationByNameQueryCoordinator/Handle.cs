...
public sealed class Handle
{
    ...
    private static Expression<Func<DCreateQueryThroughFactory<IGetTypeParameterRepresentationByNameQueryFactory, IGetTypeParameterRepresentationByNameQuery>, bool>> MatchQueryCreationDelegate(
        string name)
    {
    ...
    private static bool VerifyQueryCreationDelegate(
        DCreateQueryThroughFactory<IGetTypeParameterRepresentationByNameQueryFactory, IGetTypeParameterRepresentationByNameQuery> queryCreationDelegate,
        string name)
    {
