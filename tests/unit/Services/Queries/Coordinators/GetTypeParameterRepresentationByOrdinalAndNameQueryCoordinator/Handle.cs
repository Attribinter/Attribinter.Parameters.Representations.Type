...
public sealed class Handle
{
    ...
    private static Expression<Func<DCreateQueryThroughFactory<IGetTypeParameterRepresentationByOrdinalAndNameQueryFactory, IGetTypeParameterRepresentationByOrdinalAndNameQuery>, bool>> MatchQueryCreationDelegate(
        int ordinal,
        string name)
    {
    ...
    private static bool VerifyQueryCreationDelegate(
        DCreateQueryThroughFactory<IGetTypeParameterRepresentationByOrdinalAndNameQueryFactory, IGetTypeParameterRepresentationByOrdinalAndNameQuery> queryCreationDelegate,
        int ordinal,
        string name)
    {
