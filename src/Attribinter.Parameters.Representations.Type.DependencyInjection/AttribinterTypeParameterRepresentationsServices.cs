...
/// <summary>Allows the services provided by <i>Attribinter.Parameters.Representations.Type</i> to be registered with a <see cref="IServiceCollection"/>.</summary>
public static class AttribinterTypeParameterRepresentationsServices
{
    /// <summary>Registers the services provided by <i>Attribinter.Parameters.Representations.Type</i> with the provided <see cref="IServiceCollection"/>.</summary>
